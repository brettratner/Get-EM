...
public class SpeedPowerUps2 : MonoBehaviour {
	...
	void Update () {
		if (starGotten1 == true) {
			...
			if(speedTimeout1 < 0)
			{
				...
				movePlayer2.speed = myplayerOGSpeed;
			}
		}
		if (starGotten2 == true) {
		...
		if (antistarGotten4 == true) {
			...
			if(speedTimeout4 < 0)
			{
				...
				movePlayer.speed = otherplayerOGSpeed;
			}
		}
